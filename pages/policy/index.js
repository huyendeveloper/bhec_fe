                ...
                >
                  <div className={classes.content}>
                    <div className={classes.block}>
                      {'株式会社Branding House（以下「当社」という）は、ユーザーおよび当社に関係する皆様からお預かりする個人情報を厳格に保護し、適切に取扱うことが当社運営上の重要課題であると認識しております。'} <br/>
                      {'ユーザーが、当社の運営するウェブサイト「OSHINAGAKI」（以下「本サービス」）という）を利用した場合、下記のプライバシーポリシーに同意されたものとみなします。当社は、個人情報の保護に適用される法令、ガイドラインおよびその他の規範を遵守するとともに、個人情報保護方針を定めその保護に努めます。'}<br/>
                    </div>
                    <div className={classes.block}>
                      {'1．個人情報'}
                    ...
                    <div className={classes.block}>
                      {'3．個人情報利用の目的'}<br/>
                      {'①本サービスの提供・運営のため'}<br/>
                      {'②ユーザーからのお問合せに回答するため（本人確認を行うことを含む）'}<br/>
                      {'③ユーザーが利用中のサービスの新機能、更新情報、キャンペーン等および当社が提供する他のサービスの案内メールを送信するため'}<br/>
                    ...
                    <div className={classes.block}>
                      {'10．お問い合わせ窓口 『本ポリシーに関するお問い合わせ』は当社へお問い合わせください。'}
                    </div>
                  </div>
                </Grid>
              </Grid>
