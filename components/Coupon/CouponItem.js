...
const CouponItem = ({coupon, handleSubmit, haveBottomBorder}) => {
  ...
  let isExpired = coupon?.coupon?.is_indefinite_period ? false : moment(coupon?.coupon?.expiration_time).isBefore(new Date());
          ...
          <div className={classes.topContainer}>
            ...
            <div className={classes.couponExpiryDate}>
              <div className={classes.expiryDateContainer}>
                ...
                >
                  {coupon?.coupon?.is_indefinite_period ? '利用期限なし' : (moment(coupon.coupon?.expiration_time).format('YYYY年MM月DD日') + 'まで')}
                </Typography>
              </div>
